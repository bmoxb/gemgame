...
pub fn draw(tile: &Tile, x: f32, y: f32, draw_size: f32, texture_rect_size: f32, texture: quad::Texture2D) {
    ...
    let params = quad::DrawTextureParams { dest_size: None, source: Some(rect), rotation: 0.0, pivot: None };
...
pub fn draw_pending_tile(x: f32, y: f32, draw_size: f32) {
    ...
    quad::draw_rectangle(x + offset, y + offset, reduced_size, reduced_size, quad::GRAY);
}
